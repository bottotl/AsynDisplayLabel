...
static void DeallocCallback(void *ref) {
    JFTTextRunDelegate *self = (__bridge_transfer JFTTextRunDelegate *)(ref);
    self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
    JFTTextRunDelegate *self = (__bridge JFTTextRunDelegate *)(ref);
    return self.ascent;
}
...
@implementation JFTTextRunDelegate
