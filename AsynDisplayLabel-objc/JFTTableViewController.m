...
- (void)viewDidLoad {
    ...
    for (int i = 0 ; i < 100 ; i ++ ) {
        [self.dataSource addObject:[self createAttachmentAttributeString:i]];
    }
...
- (NSAttributedString *)createAttachmentAttributeString:(NSInteger)index {
    NSMutableAttributedString *attr = [[NSMutableAttributedString alloc] initWithString:@"测试 attachment"];
    
    NSMutableAttributedString *attachmentAttr = [NSMutableAttributedString jft_attachment:@"view" width:40 ascent:40 descent:40 creationBlock:^UIView *(id context) {
